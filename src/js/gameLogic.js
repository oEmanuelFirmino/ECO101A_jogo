...
import { phaseConfigs, images, MAP_WIDTH, MAP_HEIGHT, PLAYABLE_AREA_BORDER, VIEWPORT_HEIGHT, VIEWPORT_WIDTH } from './config.js';
...
export function updateCamera() {
  ...
  cam.x = player.x - (MAP_WIDTH - PLAYABLE_AREA_BORDER * 2) / 2;
  cam.y = player.y - (MAP_HEIGHT - PLAYABLE_AREA_BORDER * 2) / 2;
