...
export const assetSources = {
 ...
 itemFireRate: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 30 30'%3E%3Crect x='10' y='5' width='10' height='20' fill='%2399ff99' stroke='%23000' stroke-width='1'/%3E%3Cpath d='M22 8 l5 -3 v20 l-5 -3' fill='none' stroke='%2399ff99' stroke-width='2'/%3E%3C/svg%3E",
 ...
 gun: "./images/gun.png", // <-- ADICIONE ESTA LINHA
};

export const images = {};

export const phaseConfigs = [
   { objectiveType: "survive", duration: 40, objectiveText: "Sobreviva por 40 segundos!", maxEnemies: 5, spawnInterval: 3000, enemyTypes: ["normal"], },
   ...
   { objectiveType: "reach_portal", objectiveText: "Alcance o portal!", maxEnemies: 8, spawnInterval: 2800, enemyTypes: ["normal", "tank"], },
   ...
   { objectiveType: "reach_portal", objectiveText: "Alcance o portal no castelo amaldiçoado!", maxEnemies: 15, spawnInterval: 1200, enemyTypes: ["fast", "tank"], },
];